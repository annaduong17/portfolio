  ...
  return (
    <div id="contact-page" className="page-margin page-padding">
      ...
      <section className="contact-info">
        ...
        <p>Check out my <a target="_blank" rel="noreferrer" href="https://github.com/annaduong17">GitHub</a></p>
      </section>
      ...
      <section className="contact-info">
        ...
        <p>Connect with me on <a target="_blank" rel="noreferrer" href="https://www.linkedin.com/in/annaduong17/">LinkedIn</a></p>
      </section>
