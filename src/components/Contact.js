  ...
  return (
    <div className='contact'>
      ...
      <section className="contact-info">
        <a className="icon-link" href="mailto:aduong9417@gmail.com">
      ...
      <section className="contact-info">
        <a className="icon-link" href="/files/resume.pdf">
      ...
      <section className="contact-info">
        <a className="icon-link" href="https://github.com/annaduong17?tab=repositories">
      ...
      <section className="contact-info">
        <a className="icon-link" href="https://www.linkedin.com/in/annaduong17/">
