  ...
  return (
    <div id="contact-page">
      ...
      <section className="contact-info">
        <a target="_blank" rel="noreferrer" className="icon-link" href="mailto:aduong9417@gmail.com">
        ...
        <p>Email me at <a target="_blank" rel="noreferrer" href="mailto:aduong9417@gmail.com" type="email">aduong9417@gmail.com</a></p>
      </section>

      <section className="contact-info">
        <a target="_blank" rel="noreferrer" className="icon-link" href="https://github.com/annaduong17">
        ...
        <p>Check out my <a target="_blank" rel="noreferrer" href="https://github.com/annaduong17" type="email">GitHub</a></p>
      </section>
      ...
      <section className="contact-info">
        ...
        <p>Connect with me on <a target="_blank" rel="noreferrer" href="https://www.linkedin.com/in/annaduong17/" type="email">LinkedIn</a></p>
      </section>
